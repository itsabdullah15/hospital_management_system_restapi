...
SECRET_KEY = 'django-insecure-s0+$6)b5dv1jlz#ianm9f)!18ue@@l9+z_6pyt%1lm*=$w9%)n'
...
INSTALLED_APPS = [
    ...
    'apps.users', # Auth + Roles: Admin, Doctor, Patient, Staff
    'apps.appointments', # Booking system for doctors/patients (Scheduling logic)
